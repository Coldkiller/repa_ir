...
QRCode.prototype.saveCode = function() {
    if (this._oDrawing && this._oDrawing._elCanvas) {
        // Usa el texto contenido en el código QR como el nombre del archivo
        const filename = (this._oQRCode && this._oQRCode.dataList[0]?.data) || 'qrcode';
        const sanitizedFilename = filename.replace(/[\\/:*?"<>|]/g, '_') + '.png'; 
        const link = document.createElement('a');
        link.download = sanitizedFilename;
        link.href = this._oDrawing._elCanvas.toDataURL('image/png');
        link.click();
    } else {
        console.error('No se puede guardar el código QR.');
    }
};
